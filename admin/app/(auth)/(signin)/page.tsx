...
export default function AuthenticationPage() {
  return (
    <div className="relative h-screen flex-col items-center justify-center md:grid lg:max-w-none lg:grid-cols-2 lg:px-0">
      ...
      <div className="relative hidden h-full w-full flex-col bg-[url('/adminbg.avif')] bg-cover bg-left p-10 lg:flex dark:border-r">
        <div className="text-red1 relative z-20 flex items-center gap-2 text-lg text-red-400">
