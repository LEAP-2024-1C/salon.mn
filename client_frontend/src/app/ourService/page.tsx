...
const OurServices = () => {
  return (
    <div className="bg-[#101828] text-white font-serif">
      <div className="flex justify-evenly items-start px-14  ">
          <Image  className="mt-5 ml-4"
        ...
        Lorem, ipsum dolor sit amet consectetur adipisicing elit. Cupiditate itaque
         voluptatibus rerum laudantium neque sit?
         </p>
        </div>
  
        <Image    className="mt-5 mr-4"  src="https://elementorkits.nathatype.com/barber97/wp-content/uploads/sites/30/2022/06/fashion-barber-with-mustache-dressed-in-a-black-sh-NT3C8MP_isolated.png"
        width={400}
        height={300}
        alt="barber"
        />
      ...
      <div className="pt-20">
        <p className="text-center text-4xl">Enhance your masculine through elegant hairstyle with us</p>
        <p className="w-[1500px] text-center">Dolor rhoncus, massa sit semper sit viverra eget mauris. Lacus faucibus gravida sit ut cursus consectetur auctor leo. Hac ut sit nisl diam venenatis platea.</p>
        
      </div>
      <div className="pt-20">
        <p className="text-4xl text-center">Үнэ & Үйлчилгээ</p>
        <p className="w-[1500px] text-center">Tortor neque mi sagittis eleifend donec lectus velit, viverra. Nibh at nibh dolor tristique ut erat elementum. Facilisis proin semper tristique cidunt imperdiet velit strum donec a a in ut.</p>

      </div>

      <div className="flex pt-20 gap-5  ">
      <Image className="rounded-xl ml-5"
    ...
    />
      ...
      <div>
        ...
        <div className="flex justify-between max-w-[1800px] mx-auto px-8 md:px-20 text-3xl">
           <p className="text-[#F63D68]">Засалт</p>
           <div className="flex-grow mx-4 border-b border-dotted border-gray-400"></div>
           <p>50000₮</p>
        </div>
        <div className="flex justify-between max-w-[1800px] mx-auto px-8 md:px-20 text-3xl">
